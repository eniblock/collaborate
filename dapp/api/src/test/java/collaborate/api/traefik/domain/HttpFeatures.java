...
public class HttpFeatures {
  ...
  public static final EntryPoint entryPoint = EntryPoint.builder()
      .http(Http.builder()
          .routers(Map.ofEntries(
              new SimpleEntry<>("525003f6-f85f-11eb-9a03-0242ac130003-vehicles-router",
                  Router.builder()
                      .entryPoints(List.of("websecure"))
                      .service("525003f6-f85f-11eb-9a03-0242ac130003")
                      .rule(
                          "PathPrefix(`/datasource/525003f6-f85f-11eb-9a03-0242ac130003/vehicles`)")
                      .middlewares(List.of(
                      ...
                      .build()),
              new SimpleEntry<>("525003f6-f85f-11eb-9a03-0242ac130003-kilometer-router",
                  Router.builder()
                      .entryPoints(List.of("websecure"))
                      .service("525003f6-f85f-11eb-9a03-0242ac130003")
                      .rule(
                          "PathPrefix(`/datasource/525003f6-f85f-11eb-9a03-0242ac130003/kilometer`)")
                      .middlewares(List.of(
                          "525003f6-f85f-11eb-9a03-0242ac130003-auth-headers",
                      ...
                      .build()),
              new SimpleEntry<>("525003f6-f85f-11eb-9a03-0242ac130003-maintenance-router",
                  Router.builder()
                      .entryPoints(List.of("websecure"))
                      .service("525003f6-f85f-11eb-9a03-0242ac130003")
                      .rule(
                          "PathPrefix(`/datasource/525003f6-f85f-11eb-9a03-0242ac130003/maintenance`)")
                      .middlewares(List.of(
                          "525003f6-f85f-11eb-9a03-0242ac130003-auth-headers",
          ...
          .middlewares(Map.ofEntries(
              ...
              new SimpleEntry<>("525003f6-f85f-11eb-9a03-0242ac130003-vehicles-query-params",
                  Middleware.builder()
              ...
              new SimpleEntry<>("525003f6-f85f-11eb-9a03-0242ac130003-kilometer-query-params",
                  Middleware.builder()
                      .redirectRegex(RedirectRegex.builder()
                          .regex("/([^\\?\\s]*)(\\??)(.*)")
                          .replacement(
              ...
              new SimpleEntry<>("525003f6-f85f-11eb-9a03-0242ac130003-maintenance-query-params",
                  Middleware.builder()
                      .redirectRegex(RedirectRegex.builder()
                          .regex("/([^\\?\\s]*)(\\??)(.*)")
                          .replacement("/${1}?client_id=c8fc43d5-f43f-44e5-acc2-b8aebaee90e2")
              ...
              new SimpleEntry<>("525003f6-f85f-11eb-9a03-0242ac130003-vehicles-strip-prefix",
                  Middleware.builder()
                      .stripPrefix(StripPrefix.builder()
                          .prefixes(
                              List.of("/datasource/525003f6-f85f-11eb-9a03-0242ac130003/vehicles"))
                          .build()
                      ).build()
              ),
              new SimpleEntry<>("525003f6-f85f-11eb-9a03-0242ac130003-kilometer-strip-prefix",
                  Middleware.builder()
                      .stripPrefix(StripPrefix.builder()
                          .prefixes(
                              List.of("/datasource/525003f6-f85f-11eb-9a03-0242ac130003/kilometer"))
                          .build()
                      ).build()
              ),
              new SimpleEntry<>("525003f6-f85f-11eb-9a03-0242ac130003-maintenance-strip-prefix",
                  Middleware.builder()
                      .stripPrefix(StripPrefix.builder()
                          .prefixes(List.of(
              ...
              new SimpleEntry<>("525003f6-f85f-11eb-9a03-0242ac130003-vehicles-replace-path-regex",
                  Middleware.builder()
              ...
              new SimpleEntry<>("525003f6-f85f-11eb-9a03-0242ac130003-kilometer-replace-path-regex",
                  Middleware.builder()
                      .replacePathRegex(new ReplacePathRegex(
  ...
  public static final String entryPointYaml  = TestResources.read("/traefik/domain/entrypoint/entrypoint.yml");
