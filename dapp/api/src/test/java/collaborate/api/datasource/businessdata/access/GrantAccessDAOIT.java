    ...
    mockServer.when(
        request()
            ...
            .withBody(
                JsonBody.json(
                    readContent(
                        "/datasource/businessdata/access/grant/fineOneAccessRequestByUUID-body-existing.json")
                )
            )
    ).respond(
        response()
            ...
            .withBody(
                JsonBody.json(
                    readContent(
                        "/datasource/businessdata/access/grant/fineOneAccessRequestByUUID-exist-result.json")
                )
            )
    );
  }
    ...
    mockServer.when(
        request()
            ...
            .withBody(
                JsonBody.json(
                    readContent(
                        "/datasource/businessdata/access/grant/fineOneAccessRequestByUUID-body-unexisting.json")
                )
            )
    ).respond(
        response()
            ...
            .withBody(
                JsonBody.json(
                    readContent(
                        "/datasource/businessdata/access/grant/fineOneAccessRequestByUUID-unexist-result.json")
                )
            )
    );
  }
