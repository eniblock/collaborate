...
@Slf4j
public class GrantSubscribeTransactionHandler implements TransactionHandler {

  private final BusinessDataKpiService businessDataKpiService;
  private final GrantedSubscribeService grantedAccessService;
  ...
  boolean isGrantAccess(Transaction transaction) {
    return GrantSubscribeDAO.GRANT_ACCESS_ENTRY_POINT.equals(transaction.getEntrypoint());
  }
