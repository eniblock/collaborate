...
class CreateServiceDataDAO {
  ...
  private final TezosApiGatewayServiceDataCreationClient tezosApiGatewayServiceDataCreationClient;
  ...
  public Job create(String metadataUri, String vehicleOwnerAddress) {
    var multisigId = tezosApiGatewayServiceDataCreationClient.getMultisigNb(
        smartContractAddress.getServiceDataProxyTokenController(),
    ...
    return MultisigBuildParam.builder()
        ...
        .callParams(
            MultisigBuildCallParamMint.builder()
                .targetAddress(smartContractAddress.getServiceData())
                .parameters(
