...
class CreateServiceConsentDAO {
  ...
  private final TezosApiGatewayServiceConsentCreationClient tezosApiGatewayServiceConsentCreationClient;
  ...
  public Job create(String metadataUri, String vehicleOwnerAddress) {
    var multisigId = tezosApiGatewayServiceConsentCreationClient.getMultisigNb(
        smartContractAddress.getServiceConsentProxyTokenController(),
    ...
    return MultisigBuildParam.builder()
        ...
        .callParams(
            MultisigBuildCallParamMint.builder()
                .targetAddress(smartContractAddress.getServiceConsent())
                .parameters(
