...
@FeignClient(url = "${tezos-api-gateway.url}/api", name = "tag-servicedata-client")
interface TezosApiGatewayServiceDataClient {
  ...
  @PostMapping("/tezos_node/storage/{contractAddress}")
  AllTokensResponseDTO getServiceDataCount(@PathVariable String contractAddress,
