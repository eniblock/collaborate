...
@FeignClient(url = "${tezos-api-gateway.url}/api", name = "tag-serviceconsent-client")
interface TezosApiGatewayServiceConsentClient {
  ...
  @PostMapping("/tezos_node/storage/{contractAddress}")
  AllTokensResponseDTO getServiceConsentCount(@PathVariable String contractAddress,
