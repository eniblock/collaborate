...
import collaborate.api.traefik.domain.entrypoint.middleware.Headers;
import collaborate.api.traefik.domain.entrypoint.middleware.Middleware;
import collaborate.api.traefik.domain.entrypoint.servertransport.Certificates;
    ...
    serversTransport = ServersTransport.builder()
        .certificates(List.of(
            Certificates.builder()
                .certFile(Paths.get(certificatesPath, datasourceName + ".cer").toString())
                .keyFile(Paths.get(certificatesPath, datasourceName + ".pem").toString())
                .build()
        ))
