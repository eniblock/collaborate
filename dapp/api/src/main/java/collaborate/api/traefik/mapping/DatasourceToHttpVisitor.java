...
import collaborate.api.traefik.domain.entrypoint.Http;
import collaborate.api.traefik.routing.DatasourceNameSupplier;
import collaborate.api.traefik.routing.FromRoutePrefixSupplier;
import collaborate.api.traefik.routing.FromRouteRegexSupplier;
import collaborate.api.traefik.routing.RoutingKeyKeywordSupplier;
...
public class DatasourceToHttpVisitor implements DatasourceVisitor {
  ...
  @Override
  public void visitWebServerDatasource(WebServerDatasource datasource) {
  ...
  private HttpAuthenticationVisitor initHttpAuthenticationVisitor(
      DatasourceNameSupplier datasourceNameSupplier, Datasource dataSource) {
