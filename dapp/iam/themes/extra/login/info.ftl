        ...
        <div id="kc-info-message">
            ...
            <#else>
                <#if pageRedirectUri?has_content>
                    <p>
                        <a class="mdc-link-button mdc-button mdc-button--raised"
                           href="${pageRedirectUri}">${kcSanitize(msg("backToApplication"))?no_esc}</a>
                    </p>
                <#elseif actionUri?has_content>
                    <p>
                        <a class="mdc-link-button mdc-button mdc-button--raised"
                           href="${actionUri}">${kcSanitize(msg("proceedWithAction"))?no_esc}</a>
                    </p>
