          ...
          <div class="${properties.kcFormGroupClass!}">
            <div id="kc-form-options" class="${properties.kcFormOptionsClass!}">
              ...
              <div id="kc-form-buttons" class="col-xs-5 ${properties.kcFormButtonsClass!}">
                ...
                <button class="mdc-link-button mdc-button mdc-button--raised mdc-register-button ${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonLargeClass!}"
                        onclick="goToRegistration();return false;" id="kc-register" type="button">
                  ${msg("createAccount")}
                </button>
