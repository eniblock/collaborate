                ...
                <form id="kc-form-login" class="form ${properties.kcFormClass!}" action="${url.loginAction}"
                    ...
                    <div class="username-container ${properties.kcFormGroupClass!}">
                        <div class="${properties.kcInputWrapperClass!}">
                            <div class="mdc-text-field mdc-text-field--outlined ${properties.kcLabelClass!} <#if usernameEditDisabled??>mdc-text-field--disabled</#if>">
                    ...
                    <a id="forgot-password-link" href="#" onclick="goToForgotPassword();return false;">Forgot your
                        password ?</a>
                        ...
                        <div id="kc-form-options" class="${properties.kcFormOptionsClass!}">
                            ...
                            <div id="kc-form-buttons" class="col-xs-5 ${properties.kcFormButtonsClass!}">
                                ...
                                <div class="btn-separator">
                                    <div class="separator"></div>
                                    <span class="btn-separator-text">${msg("or")}</span>
                                    <div class="separator"></div>
                                </div>

                                <#--                                <a href="${adminUrl}">test</a>-->

                                <a class="mdc-link-button mdc-button mdc-button--raised mdc-register-button ${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonLargeClass!}"
                                   href="#" onclick="goToRegistration();return false;" id="kc-register" type="button">
                                    ${msg("createAccount")}
                                </a>
